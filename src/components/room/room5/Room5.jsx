...
import button6Img from "../button/button6.png";
...
export default function Room5() {
  ...
  const handleGoToRoom6 = () => {
    setCurrentRoom(6);
  };

  return (
    <div style={{ position: 'relative', width: '1000px', height: '800px', margin: '0 auto' }}>
      <img src={room5} alt="Room 5" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
        ...
        {isLoggedIn && (
          <div style={{ position: 'absolute', bottom: '20px', left: '50%', transform: 'translateX(-50%)' }}>
            <ImageButton src={goBackImg} alt="뒤로가기" onClick={handleGoToRoom2} />
          </div>
        )}
        
        {isLoggedIn && (
          <div style={{ position: 'absolute', bottom: '20px', left: '20px' }}>
            <ImageButton src={button6Img} alt="6번방으로" onClick={handleGoToRoom6} />
          </div>
        )}
